...
local function gotoBypass()
	composer.gotoScene ("bypass")
end
local function gotoKeypad()
	composer.gotoScene ("keypad")
end
...
function scene:create( event )
	...
	local textBox = display.newText (sceneGroup, "Does it have anti-tamper systems?", display.contentCenterX, 40,display.contentWidth, 0,  native.systemFont, 20)
	textBox:setFillColor(0.82,0.86,1)
	
	Y = 100;
	
	Y = tbox("Yes", Y, gotoBypass,"Bad")
	Y = tbox("No", Y, gotoKeypad,"Good")
