...
function scene:create( event )
	...
	local textBox = display.newText (sceneGroup, "If fake print is used, make an Opposed Test between the duplicate and the maglock rating: If the fake wins, the maglock accepts it.", display.contentCenterX, 40,display.contentWidth, 0,  native.systemFont, 20)
