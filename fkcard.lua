...
local function gotoOpen()
	composer.gotoScene ("open")
end
...
function scene:create( event )
	...
	local textBox = display.newText (sceneGroup, "The forged keycard uses its Rating x2 in an Opposed Test against the Maglock Rating x2", display.contentCenterX, 40,display.contentWidth, 0,  native.systemFont, 20)
	textBox:setFillColor(0.82,0.86,1)
	
	Y = 100;
	Y = tbox("Success", Y, gotoOpen, "Good")
	Y = tbox("Fail", Y, gotoFail, "Bad")
