...
function scene:create( event )
	...
	local textBox = display.newText (sceneGroup, "Locksmith + Agility [Physical] (Maglock Rating x2, 1 Combat Turn) Extended Test", display.contentCenterX, 40,display.contentWidth, 0,  native.systemFont, 20)
