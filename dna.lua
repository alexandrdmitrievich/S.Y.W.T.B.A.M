...
function scene:create( event )
	...
	local textBox = display.newText (sceneGroup, "Take sample of genetic material, preserved enzyme bath, Chemistry shop is needed", display.contentCenterX, 40,display.contentWidth, 0,  native.systemFont, 20)
	textBox:setFillColor(0.82,0.86,1)
	
	Y = 100;
	
	Y = tbox("Chemistry + Logic (5, 1 hour) Extnded Test", Y, blank, "None")
