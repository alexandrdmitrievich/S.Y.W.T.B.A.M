...
local function gotoFKCard()
	composer.gotoScene ("fkcard")
end
...
function scene:create( event )
	...
	local textBox = display.newText (sceneGroup, "Use a keycard copier then use Hardware kit, abour ten minutes, and a Hardware + Logic [Mental] (2) Test", display.contentCenterX, 40,display.contentWidth, 0,  native.systemFont, 20)
	textBox:setFillColor(0.82,0.86,1)
	
	Y = 100;
	Y = tbox("Success", Y, gotoFKCard, "Good")
	Y = tbox("Fail", Y, gotoBreak, "Bad")
