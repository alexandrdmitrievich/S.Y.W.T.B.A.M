...
function scene:create( event )
	...
	local textBox = display.newText (sceneGroup, "Can you steal a card?", display.contentCenterX, 40,display.contentWidth, 0,  native.systemFont, 20)
	textBox:setFillColor(0.82,0.86,1)
	
	Y = 100;
	Y = tbox("Yes", Y, gotoWhy, "Good")
	Y = tbox("Yes, but only for a few seconds", Y, gotoKCcopier, "Good")
	Y = tbox("No", Y, gotoBreak, "Bad")
