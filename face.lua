...
function scene:create( event )
	...
	local textBox = display.newText (sceneGroup, "Opposed Test", display.contentCenterX, 40,display.contentWidth, 0,  native.systemFont, 20)
	textBox:setFillColor(0.82,0.86,1)
	
	Y = 100;
	
	Y = tbox("Disguise + Intuition [Mental] against the Device Raiting", Y, blank, "None")
	Y = tbox("+2 dice pool if picjing out a crowd", Y, blank, "None")
