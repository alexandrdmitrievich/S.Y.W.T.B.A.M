...
local function gotoSq()
	composer.gotoScene ("sq")
end
...
function scene:create( event )
	...
	local textBox = display.newText (sceneGroup, "Do you have a maglock sequencer?", display.contentCenterX, 40,display.contentWidth, 0,  native.systemFont, 20)
	textBox:setFillColor(0.82,0.86,1)
	
	Y = 100;
	
	Y = tbox("Yes", Y, gotoSq, "Bad")
