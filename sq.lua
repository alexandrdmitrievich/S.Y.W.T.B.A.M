...
function scene:create( event )
	...
	local textBox = display.newText (sceneGroup, "Make an Opposed Test between the sequencer and maglock ratings", display.contentCenterX, 40,display.contentWidth, 0,  native.systemFont, 20)
