...
function scene:create( event )
	...
	local textBox = display.newText (sceneGroup, "Try shooting the case off..", display.contentCenterX, 40,display.contentWidth, 0,  native.systemFont, 20)
	textBox:setFillColor(0.82,0.86,1)
	
	Y = 100;
	
	Y = tbox("Barrier rating equal to the maglock rating", Y, blank)
