...
function scene:create( event )
	...
	local textBox = display.newText (sceneGroup, "Maglock does not open and a alarm may be triggered", display.contentCenterX, 40,display.contentWidth, 0,  native.systemFont, 20)
	textBox:setFillColor(1,0.86,0.82)
	
	Y = 100;
	

	Y = tbox("Start over", Y, gotoMain, "Bad")
