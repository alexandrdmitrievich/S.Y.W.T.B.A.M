...
function scene:create( event )
	...
	local textBox = display.newText (sceneGroup, "To Bypass: Locksmith + Agility [Physical] (anti-tamper system rating)", display.contentCenterX, 40,display.contentWidth, 0,  native.systemFont, 20)
	textBox:setFillColor(0.82,0.86,1)
	
	Y = 100;
	
	Y = tbox("Fail", Y, gotoFail, "Bad")
	Y = tbox("Success", Y, gotoOpening, "Good")
