...
function scene:create( event )
	...
	local textBox = display.newText (sceneGroup, "Opposed Test between the system and either a recording, someother simulation, or Voice modulation cyberwere", display.contentCenterX, 40,display.contentWidth, 0,  native.systemFont, 20)
